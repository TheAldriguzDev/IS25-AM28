...
//        dicesResults.add(6); // dall'alto, piccolo
    ...
    @Test void test_first_eliminated_second_third_fourth_hit() {
        ...
        // First round
        actionJSON = new PiratesJSON("Player 1", false, ShieldsToActivate, 0); // Total FirePower: 2
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());

        actionJSON = new PiratesJSON("Player 2", false, ShieldsToActivate, 0); // Total FirePower: 2
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());

        actionJSON3 = new PiratesJSON("Player 3", false, ShieldsToActivate, 0); // Total FirePower: 3
        pirates.useCard(actionJSON3);
        assertFalse(pirates.hasFinished());

        actionJSON4 = new PiratesJSON("Player 4", false, ShieldsToActivate, 0); // Total FirePower: 3
        ...
        ShieldsToActivate = new ArrayList<>();
        actionJSON = new PiratesJSON("Player 1", false, ShieldsToActivate, 0);
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());


        ShieldsToActivate = new ArrayList<>();
        actionJSON = new PiratesJSON("Player 2", false, ShieldsToActivate, 0);
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());

        ShieldsToActivate = new ArrayList<>();
        actionJSON = new PiratesJSON("Player 3", false, ShieldsToActivate, 0);
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());

        ShieldsToActivate = new ArrayList<>();
        ShieldsToActivate.add(new int[] {5, 7}); // Attivazione inutile, verrà distrutto, però verifico il consumo di energia
        actionJSON = new PiratesJSON("Player 4", false, ShieldsToActivate, 0);
        pirates.useCard(actionJSON);
        assertFalse(pirates.hasFinished());
...
//        assertTrue(pirates.hasFinished());
    ...
    public void test_first_defeats_and_takes_credits() {
        ...
        actionJSON1 = new PiratesJSON("Player 1", true, ShieldsToActivate, 1); // Total FirePower: 4
        actionJSON2 = new PiratesJSON("Player 2", false, ShieldsToActivate, 0); // Total FirePower: 2
        actionJSON3 = new PiratesJSON("Player 3", false, ShieldsToActivate, 0); // Total FirePower: 3
        actionJSON4 = new PiratesJSON("Player 4", false, ShieldsToActivate, 0); // Total FirePower: 3
