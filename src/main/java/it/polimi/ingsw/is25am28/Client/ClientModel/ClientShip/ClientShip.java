...
//        this.addComponent(this.core, grid_rows/2, grid_cols/2);
    ...
    /**
     * This method takes in input the storage list generated by the generateComponentSublist() and return the available color tupes
     */
    public List<ItemColor> getAvailableShipItemColors() {
        List<ItemColor> itemColors = new ArrayList<>();
        List<ItemColor> items = this.getAllItems().stream().map(Item::getColor).toList();
