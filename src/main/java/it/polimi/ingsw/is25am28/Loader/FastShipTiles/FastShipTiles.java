...
public class FastShipTiles {
    @JsonProperty("0")      private List<FastShipTilesInfo> firstShipTiles;
    @JsonProperty("1")      private List<FastShipTilesInfo> secondShipTiles;
    @JsonProperty("2")      private List<FastShipTilesInfo> thirdShipTiles;
    @JsonProperty("3")      private List<FastShipTilesInfo> fourthShipTiles;
