...
public final class Shield extends Component {
    ...
    protected void setComponentScreen(WidgetTUI componentWidget) throws NullWidgetException {
        ...
        String nameAlias = ComponentAlias.SHIELD.getAlias();
        ...
        switch (this.getDirection()) {
            ...
            case 0 -> {
                ...
                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_TOP_SINGLE_LINE, ANSIColors.GREEN).repeat(width - 3));
                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_TR_CORNER, ANSIColors.GREEN));
                paddedString.append(getSpace());
                ...
                for (int i = 1; i < height; i++) {
                    ...
                    paddedString.append(addColor(UnicodeBlockElements.VERTICAL_RIGHT_SINGLE_LINE, ANSIColors.GREEN));
                    paddedString.append(getSpace());
            ...
            case 1 -> {
                ...
                paddedString.append(getSpace());
                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_TOP_SINGLE_LINE, ANSIColors.GREEN).repeat(width - 3));
                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_BR_CORNER, ANSIColors.GREEN));
                paddedString.append(getSpace());
                screen.add(paddedString.toString());
            }
            ...
            case 2 -> {
                ...
                paddedString = new StringBuilder();
                paddedString.append(getSpace());
                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_BL_CORNER, ANSIColors.GREEN));
                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_TOP_SINGLE_LINE, ANSIColors.GREEN).repeat(width - 3));
                paddedString.append(getSpace());
                screen.add(paddedString.toString());
            }
            ...
            case 3 -> {
                paddedString = new StringBuilder();
                paddedString.append(getSpace());
                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_TL_CORNER, ANSIColors.GREEN));
                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_TOP_SINGLE_LINE, ANSIColors.GREEN).repeat(width - 3));
                paddedString.append(getSpace());
                screen.add(paddedString.toString());
...
//                paddedString = new StringBuilder();
//                paddedString.append(getSpace());
//                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_TOP_SINGLE_LINE, ANSIColors.GREEN).repeat(width));
//                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_TR_CORNER, ANSIColors.GREEN));
//                paddedString.append(getSpace());
//                screen.add(paddedString.toString());
//
...
//                paddedString = new StringBuilder();
//                paddedString.append(getSpace());
//                paddedString.append(addColor(UnicodeBlockElements.HORIZONTAL_BOTTOM_SINGLE_LINE, ANSIColors.GREEN).repeat(width));
//                paddedString.append(addColor(UnicodeBlockElements.SINGLE_LINE_BR_CORNER, ANSIColors.GREEN));
//                paddedString.append(getSpace());
//                screen.add(paddedString.toString());
//            }
...
//                        paddedString = new StringBuilder();
//                        paddedString.append(getSpace());
//                        paddedString.append(addColor(UnicodeBlockElements.VERTICAL_LEFT_SINGLE_LINE, ANSIColors.GREEN));
//                        paddedString.append(getSpace().repeat(padding));
//                        paddedString.append(addColor(ComponentAlias.SHIELD.getAlias(), ANSIColors.GREEN));
//                        paddedString.append(getSpace().repeat(padding));
//                    } else {
