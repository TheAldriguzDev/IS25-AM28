...
public class UpdateHandler {
    ...
    public void processUpdate(Answer answer) {
        ...
        switch (state) {
            case ConstructionComponentDTO _, ReservedComponentDTO _, PlacedComponentDTO _, TimerDTO _, FixedComponentDTO _, PopulateShipComponentDTO _, ConstructionDeckDTO _-> {
            ...
            case PlayerEndedShipDTO _, FastShipDTO _ -> {
