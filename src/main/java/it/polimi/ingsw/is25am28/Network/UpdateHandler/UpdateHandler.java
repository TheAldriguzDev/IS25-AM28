...
/**
 * The UpdateHandler class is responsible for managing and processing game state updates
 * that are generated by the server. It utilizes multiple threads to handle updates,
 * input commands, and forced transitions efficiently.
 */
public class UpdateHandler {
    ...
    /**
     * Processes an update based on the provided answer. The method handles the current and next
     * states from the Answer object.
     *
     * @param answer the message received from the server containing the player's nickname,
     *               current state, and next state for model and UI updates
     */
    ...
    /**
     * Reports an error update by delegating the error message to the view updater.
     * The error is processed asynchronously using the input thread.
     *
     * @param error the {@code ErrorAnswer} object containing the error details
     */
